<div id="app">
	...
	<header class="header">
		<div class="conteiner header-flex">
			...
			<div class="header-right">
				...
				<div class="button sign"><a href="/checkout/">My Account&nbsp;&nbsp;<i class="fa fa-caret-down" aria-hidden="true"></a></i>
					<!--<div class="sign_drop">
	...
	<nav class="navigation">
		<ul class="menu">
			...
			<li class="menu-list-li"><a href="/catalog" class="menu-list">Kids</a></li>
			<li class="menu-list-li"><a href="/catalog" class="menu-list">Accoseriese</a></li>
			<li class="menu-list-li"><a href="/catalog" class="menu-list">Featured</a></li>
			<li class="menu-list-li"><a href="/catalog" class="menu-list">Hot Deals </a>
